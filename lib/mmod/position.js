...
mod.prototype.setPosition = function() {
    this.box = main.panel.actor.get_parent();
    this.box.ge
    this.monitor = main.layoutManager.primaryMonitor;
    ...
    switch( e )
    {
        case EDGE_BOTTOM:
        {
            this.box.set_position(this.monitor.x, this.monitor.height - ( this.box.get_height() ) );
            break;
        }

        case EDGE_TOP:
        {
            this.box.set_position(this.monitor.x, this.monitor.y );
            break;
        }
    }
...
mod.prototype.init = function()
{
    ...
    this.heightChangeInterval = mainloop.timeout_add
        (
            100,
            lang.bind
            (
